...
- As a tool with command line arguments for code evaluation, which makes it possible for the interpreter to be used with other editors.
...
In order to get started with RainLisp, you visit its [repository](https://github.com/chr1st0scli/RainLisp) where you can find a tutorial and other material.
